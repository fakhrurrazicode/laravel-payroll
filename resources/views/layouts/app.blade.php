...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('vendors/bootstrap-table/bootstrap-table.min.css') }}">
...
<body class="loading"
                ...
                <ul class="list-unstyled topnav-menu float-end mb-0">
                    ...
                    <li class="dropdown d-none d-lg-inline-block topbar-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item">
                                <img src="{{ asset('shreyu/dist/assets/images/flags/germany.jpg') }}"
            ...
            <div class="h-100" data-simplebar>
                ...
                <div id="sidebar-menu">
                    <ul id="side-menu">
                        ...
                        <li>
                            <a href="#users-management" data-bs-toggle="collapse">
    ...
    <script src="{{ asset('vendors/bootstrap-table/extensions/custom-view/bootstrap-table-custom-view.min.js') }}">
    </script>
