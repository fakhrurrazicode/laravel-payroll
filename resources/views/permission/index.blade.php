                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="table-data-toolbar">
                            <a class="btn btn-primary" id="btn-create" href="{{route('permission.create')}}"><i class="fa fa-plus"></i> Create new</a>
                        </div>
...
<script>
    $(function(){
        $("#table-data").bootstrapTable({
            ...
            url: "{{URL::to('/permission/table_data')}}",
            columns: [
                {
                    field: "id",
                    title: "Action",
                    ...
                    formatter: function (id, row, index) {
                        var html = `<a class="btn btn-sm btn-primary btn-edit" href="{{URL::to('permission')}}/${id}/edit"><i class="fa fa-edit"></i> Edit</a> `;
                ...
                success: function(result){
                    ...
                    if(status){
                        ...
                        if(permission){
                            ...
                            modal_delete.find('#identifier-delete').html(permission.name);
                        }
                    }else{
                        Swal.fire({
                            title: 'Error!',
        ...
        $('#form-delete').on('submit', function(e){
            ...
            $.ajax({
                url: "{{URL::to('permission')}}/" + form_delete.find('#id').val(),
                type: 'POST',
