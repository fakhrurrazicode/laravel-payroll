                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-5">
                                        <select class="form-select @error('guard_name') is-invalid @enderror"
                                            ...
                                            <option {{ old('guard_name') == 'web' ? 'selected=""' : '' }} value="web">Web
                                            </option>
                                            <option {{ old('guard_name') == 'api' ? 'selected=""' : '' }} value="api">Api
                                            </option>
                                        </select>
                                        @error('guard_name')
                                ...
                                <div class="row">
                                    <div class="col-lg-12 offset-lg-2">
                                        ...
                                        <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i>
                                            Save</button>
                                        <a href="{{ route('permission.index') }}" class="btn btn-secondary"><i
