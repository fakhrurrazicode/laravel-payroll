                                        ...
                                        @foreach(Permission::all() as $permission)
                                            <div class="col-lg-4">
                                                <div class="form-check">
                                                    <input class="form-check-input permissions" type="checkbox" value="{{$permission->id}}" id="permission_{{$permission->id}}" name="permission_ids[]" {{old('permission_ids.'. $permission->id) ? 'checked=""' : ''}}>
