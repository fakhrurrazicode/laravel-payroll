    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">List of Jabatan</div>

                        <div class="card-body">
                            <div id="table-data-toolbar">
                                <a class="btn btn-primary" id="btn-create" href="{{ route('jabatan.create') }}"><i
    ...
    <script>
        $(function() {
            $("#table-data").bootstrapTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        title: "Gaji Pokok",
                        sortable: true,
                        formatter: function(gaji_pokok) {
                            return 'Rp. ' + number_format(gaji_pokok, 0, ',', '.')
                        }
                    },
                    ...
                    success: function(result) {
                        ...
                        if (status) {
                            ...
                            if (jabatan) {
                                ...
                                $.each(jabatan, function(key, value) {
                                    form_delete.find('#' + key).val(value);
                                });
                                modal_delete.find('#identifier-delete').html(jabatan.name);
                            }
                        } else {
                            Swal.fire({
                                title: 'Error!',
            ...
            $('#form-delete').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ URL::to('jabatan') }}/" + form_delete.find('#id').val(),
                    type: 'POST',
